...
>_**__NOTA:__** Todos os valores de chaves ou configurações demonstrados aqui são inválidos e não podem ser usados.
...
>_**__NOTA:__** Lembre-se de salvar o _"Secret Key"_ no momento de sua exibição. Depois disso, este não poderá ser visualizado.
...
>_**__NOTA:__** Lembre-se de salvar o _"Auth Token"_ no momento de sua exibição. Depois disso, este não poderá ser visualizado.
...
10.3 - Checar o acesso ao cluster:
...
11.5 - Para verificar se as imagens estão no _[Container Registry](https://docs.oracle.com/en-us/iaas/Content/Registry/Concepts/registryoverview.htm)_, é possível utilizar o comando abaixo:
