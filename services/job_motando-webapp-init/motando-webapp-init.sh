...
mysql -u$MYSQL_USER -p$MYSQL_PASSWD -h$MYSQL_HOST -e "CREATE DATABASE $MYSQL_DBNAME CHARSET UTF8MB4"

mysql -u$MYSQL_USER -p$MYSQL_PASSWD -h$MYSQL_HOST -e "CREATE DATABASE $RESULTDB_DBNAME CHARSET UTF8MB4"
